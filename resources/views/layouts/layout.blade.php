...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-muted">This is a demo Film Database website. Login or Register to get into all the features of this website!</p>
                    </div>
                    <div class="col-sm-4 offset-md-1 py-4">
                        {{--
                        <h4 class="text-white">Login or Register</h4> --}}
    ...
    <footer class="text-muted">
        <div class="container">
            <p class="float-left">A film database website. Feel free to post any comments! Thanks!</p>
            <p class="float-right">
